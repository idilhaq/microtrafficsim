...
if __name__ == '__main__':
    ...
    download = [
        ...
        ('london.osm',                -0.5679, 51.2447,    0.3117, 51.7275),    # failed
        ('london-small.osm',          -0.3433, 51.3400,    0.1428, 51.6159),    # failed
        ('paris.osm',                  2.1066, 48.6778,    2.7946, 49.0316),    # failed
        ('paris-small.osm',            2.2058, 48.7863,    2.4809, 48.9209),    # failed
