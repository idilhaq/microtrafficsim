package ZZZ_NEU_microtrafficsim.osmcreator.user.selection.impl;

import ZZZ_NEU_microtrafficsim.osmcreator.Constants;
import ZZZ_NEU_microtrafficsim.osmcreator.user.selection.Selectable;
import ZZZ_NEU_microtrafficsim.osmcreator.user.selection.Selection;
import javafx.scene.input.MouseEvent;
import javafx.scene.layout.Pane;
import javafx.scene.shape.Rectangle;
import javafx.scene.shape.StrokeLineCap;
import ZZZ_NEU_microtrafficsim.osmcreator.user.selection.SelectionModel;
