package ZZZ_zoomable_microtrafficsim.osmcreator.user.gestures.selection.impl;
...
import ZZZ_zoomable_microtrafficsim.osmcreator.user.gestures.selection.SelectionModel;
