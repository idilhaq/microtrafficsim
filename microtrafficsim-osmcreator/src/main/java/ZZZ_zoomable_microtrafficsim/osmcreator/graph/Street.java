...
import ZZZ_zoomable_microtrafficsim.osmcreator.geometry.Arrow;
    ...
    private class Binded {
        ...
        private void bind(DoubleProperty startX, DoubleProperty startY, DoubleProperty endX, DoubleProperty endY) {
            ...
            startXProperty.addListener((observable, oldValue, newValue) -> {
                ...
                double versatzX = 0;//Constants.CROSSROAD_RADIUS * Math.cos(radians) + Constants.STREET_STROKE_WIDTH;
                double versatzY = 0;//Constants.CROSSROAD_RADIUS * Math.sin(radians) + Constants.STREET_STROKE_WIDTH;
